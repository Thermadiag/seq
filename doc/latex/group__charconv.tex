...
The main functions of charconv module are \mbox{\hyperlink{namespaceseq_ad80e2e70627dd4598cda06a37b7767b6}{seq\+::to\+\_\+chars}} and \mbox{\hyperlink{namespaceseq_ad1f5c92eee4485b984df28c1ceb0f96a}{seq\+::from\+\_\+chars}} which provide a similar interface to C++17 functions std\+::from\+\_\+chars and std\+::to\+\_\+chars. They aim to provide a faster alternative to C++ streams for converting floating point and integer types from/to string. Note that they were developped to accomodate my needs, and might not be used in all circumstances.

\mbox{\hyperlink{namespaceseq_ad1f5c92eee4485b984df28c1ceb0f96a}{seq\+::from\+\_\+chars()}} is similar to std\+::from\+\_\+chars with the following differences\+:
\begin{DoxyItemize}
...
\mbox{\hyperlink{namespaceseq_ad80e2e70627dd4598cda06a37b7767b6}{seq\+::to\+\_\+chars}} is similar to std\+::to\+\_\+chars with the following differences
\begin{DoxyItemize}
...
\DoxyCodeLine{\mbox{\hyperlink{namespaceseq_afe93dbc8ebf7707cd6a49a40efb69516}{seq::read\_line\_from\_stream}}(istream, trailer);}
\DoxyCodeLine{\textcolor{comment}{//...}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Read words}}
\DoxyCodeLine{std::string word;}
\DoxyCodeLine{\mbox{\hyperlink{namespaceseq_a8dd14a20a2e7b03cebe3d48e3ae5e2ff}{seq::from\_stream}}(istream, word);}
\DoxyCodeLine{\textcolor{comment}{//...}}
\DoxyCodeLine{}
...
\DoxyCodeLine{    \mbox{\hyperlink{namespaceseq_a8dd14a20a2e7b03cebe3d48e3ae5e2ff}{seq::from\_stream}}(istream, v);}
...
Internal benchmarks show that using \mbox{\hyperlink{namespaceseq_aff00103371136fa3e5dd96eb74a400bb}{from\+\_\+stream()}} is around 20 faster (or more) than using \mbox{\hyperlink{namespaceseq_a368335418326de8bb38c9fba7642c027}{std\+::istream\+::operator$>$$>$()}} when reading floating point values from a huge string.
