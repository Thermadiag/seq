...
It was designed first to output huge matrices or tables to files and strings. Format module is based on the \mbox{\hyperlink{group__charconv}{charconv}} module to format numerical values.\hypertarget{group__format_autotoc_md25}{}\doxysubsubsection{Formatting single values}\label{group__format_autotoc_md25}
...
\DoxyCodeLine{std::string \mbox{\hyperlink{namespaceseq_1_1detail_a357d94da98d7b1a4e83f37f3852bfdc6}{str}} = \mbox{\hyperlink{namespaceseq_a21b27d9d28ab49b4e36657f9e95013c7}{fmt}}(PI);}
...
\end{DoxyCode}
\hypertarget{group__format_autotoc_md26}{}\doxysubsubsection{Formatting several values}\label{group__format_autotoc_md26}
...
\DoxyCodeLine{std::cout << \mbox{\hyperlink{namespaceseq_1_1detail_ae2ec0926cfae1c70dc01e5156c2ff400}{fmt}}(\textcolor{stringliteral}{"The answer is "}, 43,\textcolor{stringliteral}{" ..."}) << std::endl;}
\DoxyCodeLine{\textcolor{comment}{// Direct stream with nested formatting}}
\DoxyCodeLine{std::cout << \mbox{\hyperlink{namespaceseq_1_1detail_ae2ec0926cfae1c70dc01e5156c2ff400}{fmt}}(\textcolor{stringliteral}{"...Or it could be"}, \mbox{\hyperlink{namespaceseq_1_1detail_ae2ec0926cfae1c70dc01e5156c2ff400}{fmt}}(43.3,\textcolor{charliteral}{'e'}).c(10) ) << std::endl;}
\DoxyCodeLine{}
...
\DoxyCodeLine{\textcolor{keyword}{auto} f2 = \mbox{\hyperlink{namespaceseq_1_1detail_ae2ec0926cfae1c70dc01e5156c2ff400}{fmt}}(\textcolor{keywordtype}{int}(), \textcolor{stringliteral}{" + "}, fmt<double>().format(\textcolor{charliteral}{'g'}), \textcolor{stringliteral}{" = "}, fmt<double>().format(\textcolor{charliteral}{'e'}));}
...
\DoxyCodeLine{\textcolor{keyword}{auto} f3 = \mbox{\hyperlink{namespaceseq_1_1detail_ae2ec0926cfae1c70dc01e5156c2ff400}{fmt}}(pos<0, 2, 4>(), \textcolor{keywordtype}{int}(), \textcolor{stringliteral}{" + "}, seq::g<double>(), \textcolor{stringliteral}{" = "}, seq::e<double>());}
...
\DoxyCodeLine{\textcolor{keyword}{auto} header = \mbox{\hyperlink{namespaceseq_1_1detail_ae2ec0926cfae1c70dc01e5156c2ff400}{fmt}}(pos<1, 3>(),\textcolor{stringliteral}{"|"}, seq::str().c(20), \textcolor{stringliteral}{"|"}, seq::str().c(20), \textcolor{stringliteral}{"|"});}
\DoxyCodeLine{\textcolor{comment}{//line format, 2 columns of width 20 centered, separated by a '|'}}
\DoxyCodeLine{\textcolor{keyword}{auto} line = \mbox{\hyperlink{namespaceseq_1_1detail_ae2ec0926cfae1c70dc01e5156c2ff400}{fmt}}(pos<1, 3>(),\textcolor{stringliteral}{"|"}, seq::fmt<double>().c(20), \textcolor{stringliteral}{"|"}, seq::fmt<double>().c(20), \textcolor{stringliteral}{"|"});}
...
\DoxyCodeLine{std::cout << std::endl;}
\end{DoxyCode}
\hypertarget{group__format_autotoc_md27}{}\doxysubsubsection{Formatting to string or buffer}\label{group__format_autotoc_md27}
...
\DoxyCodeLine{std::string \mbox{\hyperlink{namespaceseq_1_1detail_a357d94da98d7b1a4e83f37f3852bfdc6}{str}} = \mbox{\hyperlink{namespaceseq_a21b27d9d28ab49b4e36657f9e95013c7}{seq::fmt}}(1.123456789,\textcolor{charliteral}{'g'}).str<std::string>();}
\DoxyCodeLine{std::cout<< \mbox{\hyperlink{namespaceseq_1_1detail_a357d94da98d7b1a4e83f37f3852bfdc6}{str}} << std::endl;}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{group__format_autotoc_md28}{}\doxysubsubsection{Using std\+::to\+\_\+chars}\label{group__format_autotoc_md28}
It is possible to use std\+::to\+\_\+chars instead of \mbox{\hyperlink{namespaceseq_ad80e2e70627dd4598cda06a37b7767b6}{seq\+::to\+\_\+chars}} within the format module, mostly when exact round-\/trip guarantee is mandatory. For that, you must define S\+E\+Q\+\_\+\+F\+O\+R\+M\+A\+T\+\_\+\+U\+S\+E\+\_\+\+S\+T\+D\+\_\+\+T\+O\+\_\+\+C\+H\+A\+RS and enable C++17. If C++17 is not supported by the compiler, the format module will always fallback to \mbox{\hyperlink{namespaceseq_ad80e2e70627dd4598cda06a37b7767b6}{seq\+::to\+\_\+chars}}.\hypertarget{group__format_autotoc_md29}{}\doxysubsubsection{Working with custom types}\label{group__format_autotoc_md29}
...
\DoxyCodeLine{}
\DoxyCodeLine{        \textcolor{keywordtype}{size\_t} \mbox{\hyperlink{classseq_1_1ostream__format_a17593d6d54bf0e77e8c32f5756d33b1d}{to\_string}}(std::string \& out)\textcolor{keyword}{ const}}
...
\DoxyCodeLine{            ostream\_format<T>(this-\/>\mbox{\hyperlink{structseq_1_1base__ostream__format_a847269fc7b29632927a725d1c5f41abb}{value}}().\mbox{\hyperlink{namespaceseq_1_1detail_a4abc955e0a77f9f1a5d4b9fa147745e1}{first}}, this-\/>\mbox{\hyperlink{structseq_1_1base__ostream__format_a33c08cb2cd77242552ab96e14a4d65c1}{numeric\_fmt}}()).append(out);}
\DoxyCodeLine{            out.append(\textcolor{stringliteral}{", "});}
\DoxyCodeLine{            \textcolor{comment}{// Format the second member of the pair using the internal numeric format}}
\DoxyCodeLine{            ostream\_format<T>(this-\/>\mbox{\hyperlink{structseq_1_1base__ostream__format_a847269fc7b29632927a725d1c5f41abb}{value}}().second, this-\/>\mbox{\hyperlink{structseq_1_1base__ostream__format_a33c08cb2cd77242552ab96e14a4d65c1}{numeric\_fmt}}()).append(out);}
\DoxyCodeLine{            out.append(\textcolor{stringliteral}{")"});}
\DoxyCodeLine{}
...
\DoxyCodeLine{    \}}
\DoxyCodeLine{    \textcolor{keywordtype}{int} el = \mbox{\hyperlink{namespaceseq_a1c3fc02a69112af58e297963a9e4c08c}{tock\_ms}}();}
...
\DoxyCodeLine{    el = \mbox{\hyperlink{namespaceseq_a1c3fc02a69112af58e297963a9e4c08c}{tock\_ms}}();}
