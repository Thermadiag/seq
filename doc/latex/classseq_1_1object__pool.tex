...
const Allocator \& \mbox{\hyperlink{classseq_1_1object__pool_afc2aaa432cec941d2830eac50564ea73}{get\+\_\+allocator}} () const noexcept
\begin{DoxyCompactList}\small\item\em Returns the underlying allocator object. \end{DoxyCompactList}\item 
Allocator \& \mbox{\hyperlink{classseq_1_1object__pool_a2206253ca3972c9d296cd83949ee5ec7}{get\+\_\+allocator}} () noexcept
\begin{DoxyCompactList}\small\item\em Returns the underlying allocator object. \end{DoxyCompactList}\item 
std\+::size\+\_\+t \mbox{\hyperlink{classseq_1_1object__pool_a7b9437706ca7401f89076eb2b2c91de3}{memory\+\_\+footprint}} () const noexcept
...
std\+::size\+\_\+t \mbox{\hyperlink{classseq_1_1object__pool_af96e3a376a2c0f05fa1af26444f7891a}{peak\+\_\+memory\+\_\+footprint}} () const noexcept
...
bool \mbox{\hyperlink{classseq_1_1object__pool_af972a9454e9956630a0ed8b9d906ab44}{reclaim\+\_\+memory}} () const noexcept
...
\begin{DoxyCompactList}\small\item\em Deallocate all unused memory blocks. This only makes sense if \mbox{\hyperlink{classseq_1_1object__pool_af972a9454e9956630a0ed8b9d906ab44}{reclaim\+\_\+memory()}} is false. \end{DoxyCompactList}\item 
T $\ast$ \mbox{\hyperlink{classseq_1_1object__pool_afa83f77752aa9e9d9d60d15380b76d42}{allocate}} (size\+\_\+t size)
...
{\footnotesize template$<$class... Args$>$ }\\\mbox{\hyperlink{classseq_1_1object__pool_a38e3596ddb1309e36ebc321386d6dc5d}{unique\+\_\+ptr}} \mbox{\hyperlink{classseq_1_1object__pool_ad3700f4d4fe1eaf5753ffb9383f942cc}{make\+\_\+unique}} (Args \&\&... args)
...
{\footnotesize template$<$class... Args$>$ }\\std\+::shared\+\_\+ptr$<$ T $>$ \mbox{\hyperlink{classseq_1_1object__pool_a8a439e60ea8aea9b7dbe62f03eccc8be}{make\+\_\+shared}} (Args \&\&... args)
...
As explained above, \mbox{\hyperlink{classseq_1_1object__pool_afa83f77752aa9e9d9d60d15380b76d42}{object\+\_\+pool\+::allocate()}} never fails (except with a potential std\+::bad\+\_\+alloc), and will fallback to the supplied allocator if requested number of objects is not managed by the provided object\+\_\+allocation type.

Usage example\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{classseq_1_1object__pool}{seq::object\_pool<int, std::allocator<int>}}, \mbox{\hyperlink{namespaceseq_a20e72bbc46786ab0a7095941c5d09045a668d551cd99226655e9e973b6d5be517}{seq::DefaultAlignment}}, \mbox{\hyperlink{structseq_1_1linear__object__allocation}{seq::linear\_object\_allocation<2>}} > pool;}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{int} *p1 = pool.\mbox{\hyperlink{classseq_1_1object__pool_afa83f77752aa9e9d9d60d15380b76d42}{allocate}}(1); \textcolor{comment}{// use memory blocks dedicated to allocate 1 object}}
\DoxyCodeLine{\textcolor{keywordtype}{int} *p2 = pool.\mbox{\hyperlink{classseq_1_1object__pool_afa83f77752aa9e9d9d60d15380b76d42}{allocate}}(2); \textcolor{comment}{// use memory blocks dedicated to allocate 2 object2}}
\DoxyCodeLine{\textcolor{keywordtype}{int} *p3 = pool.\mbox{\hyperlink{classseq_1_1object__pool_afa83f77752aa9e9d9d60d15380b76d42}{allocate}}(3); \textcolor{comment}{// directly call std::allocator<int>::allocate(3)}}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{classseq_1_1object__pool_autotoc_md36}{}\doxysubsubsection{Deallocation}\label{classseq_1_1object__pool_autotoc_md36}
Use \mbox{\hyperlink{classseq_1_1object__pool_a99af259462a246f9b6c46a6b00a9a782}{object\+\_\+pool\+::deallocate()}} to deallocate a memory region previously allocated with \mbox{\hyperlink{classseq_1_1object__pool_afa83f77752aa9e9d9d60d15380b76d42}{object\+\_\+pool\+::allocate()}}. A deallocation can trigger 2 types of mechanism\+:
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item Deallocated if \mbox{\hyperlink{classseq_1_1object__pool_af972a9454e9956630a0ed8b9d906ab44}{reclaim\+\_\+memory()}} is true
\item Kept internally for further reuse if \mbox{\hyperlink{classseq_1_1object__pool_af972a9454e9956630a0ed8b9d906ab44}{reclaim\+\_\+memory()}} is false.
\end{DoxyItemize}
\end{DoxyEnumerate}
\end{DoxyItemize}
...
Another exception is when dealing with std\+::unique\+\_\+ptr (see next section).\hypertarget{classseq_1_1object__pool_autotoc_md37}{}\doxysubsubsection{Unique pointers}\label{classseq_1_1object__pool_autotoc_md37}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{using} pool\_type = \mbox{\hyperlink{classseq_1_1object__pool}{seq::object\_pool<int, std::allocator<int>}}, \mbox{\hyperlink{namespaceseq_a20e72bbc46786ab0a7095941c5d09045a668d551cd99226655e9e973b6d5be517}{seq::DefaultAlignment}}, \mbox{\hyperlink{structseq_1_1linear__object__allocation}{seq::linear\_object\_allocation<1>}}, \textcolor{keyword}{true} >;}
...
\DoxyCodeLine{}
\DoxyCodeLine{p1 = pool.\mbox{\hyperlink{classseq_1_1object__pool_ad3700f4d4fe1eaf5753ffb9383f942cc}{make\_unique}}(1);   \textcolor{comment}{//unique ptr containing int(1)}}
...
The unique\+\_\+ptr generation is not enabled by default as it makes the allocation process slightly slower and require more memory (one additional pointer per allocation).\hypertarget{classseq_1_1object__pool_autotoc_md38}{}\doxysubsubsection{Statistics}\label{classseq_1_1object__pool_autotoc_md38}
At any point, the total memory footprint of an \mbox{\hyperlink{classseq_1_1object__pool}{object\+\_\+pool}} can be retrieved with \mbox{\hyperlink{classseq_1_1object__pool_a7b9437706ca7401f89076eb2b2c91de3}{object\+\_\+pool\+::memory\+\_\+footprint()}}. The peak memory footprint can be retrieved with \mbox{\hyperlink{classseq_1_1object__pool_af96e3a376a2c0f05fa1af26444f7891a}{peak\+\_\+memory\+\_\+footprint()}}.
...
\mbox{\Hypertarget{classseq_1_1object__pool_afa83f77752aa9e9d9d60d15380b76d42}\label{classseq_1_1object__pool_afa83f77752aa9e9d9d60d15380b76d42}} 
...
{\footnotesize\ttfamily template$<$class T , class Allocator  = std\+::allocator$<$\+T$>$, size\+\_\+t Align = Default\+Alignment, class object\+\_\+allocation  = linear\+\_\+object\+\_\+allocation$<$1$>$, bool Enable\+Unique\+Ptr = false, bool Generate\+Stats = false$>$ \\
T$\ast$ \mbox{\hyperlink{classseq_1_1object__pool}{seq\+::object\+\_\+pool}}$<$ T, Allocator, Align, object\+\_\+allocation, Enable\+Unique\+Ptr, Generate\+Stats $>$\+::allocate (\begin{DoxyParamCaption}\item[{size\+\_\+t}]{size }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}
...
\mbox{\Hypertarget{classseq_1_1object__pool_afc2aaa432cec941d2830eac50564ea73}\label{classseq_1_1object__pool_afc2aaa432cec941d2830eac50564ea73}} 
...
{\footnotesize\ttfamily template$<$class T , class Allocator  = std\+::allocator$<$\+T$>$, size\+\_\+t Align = Default\+Alignment, class object\+\_\+allocation  = linear\+\_\+object\+\_\+allocation$<$1$>$, bool Enable\+Unique\+Ptr = false, bool Generate\+Stats = false$>$ \\
const Allocator\& \mbox{\hyperlink{classseq_1_1object__pool}{seq\+::object\+\_\+pool}}$<$ T, Allocator, Align, object\+\_\+allocation, Enable\+Unique\+Ptr, Generate\+Stats $>$\+::get\+\_\+allocator (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [noexcept]}}



Returns the underlying allocator object. 

\mbox{\Hypertarget{classseq_1_1object__pool_a2206253ca3972c9d296cd83949ee5ec7}\label{classseq_1_1object__pool_a2206253ca3972c9d296cd83949ee5ec7}} 
\index{seq::object\_pool$<$ T, Allocator, Align, object\_allocation, EnableUniquePtr, GenerateStats $>$@{seq::object\_pool$<$ T, Allocator, Align, object\_allocation, EnableUniquePtr, GenerateStats $>$}!get\_allocator@{get\_allocator}}
\index{get\_allocator@{get\_allocator}!seq::object\_pool$<$ T, Allocator, Align, object\_allocation, EnableUniquePtr, GenerateStats $>$@{seq::object\_pool$<$ T, Allocator, Align, object\_allocation, EnableUniquePtr, GenerateStats $>$}}
\doxysubsubsection{\texorpdfstring{get\_allocator()}{get\_allocator()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily template$<$class T , class Allocator  = std\+::allocator$<$\+T$>$, size\+\_\+t Align = Default\+Alignment, class object\+\_\+allocation  = linear\+\_\+object\+\_\+allocation$<$1$>$, bool Enable\+Unique\+Ptr = false, bool Generate\+Stats = false$>$ \\
Allocator\& \mbox{\hyperlink{classseq_1_1object__pool}{seq\+::object\+\_\+pool}}$<$ T, Allocator, Align, object\+\_\+allocation, Enable\+Unique\+Ptr, Generate\+Stats $>$\+::get\+\_\+allocator (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [noexcept]}}



Returns the underlying allocator object. 

\mbox{\Hypertarget{classseq_1_1object__pool_a8a439e60ea8aea9b7dbe62f03eccc8be}\label{classseq_1_1object__pool_a8a439e60ea8aea9b7dbe62f03eccc8be}} 
...
{\footnotesize\ttfamily template$<$class T , class Allocator  = std\+::allocator$<$\+T$>$, size\+\_\+t Align = Default\+Alignment, class object\+\_\+allocation  = linear\+\_\+object\+\_\+allocation$<$1$>$, bool Enable\+Unique\+Ptr = false, bool Generate\+Stats = false$>$ \\
template$<$class... Args$>$ \\
std\+::shared\+\_\+ptr$<$T$>$ \mbox{\hyperlink{classseq_1_1object__pool}{seq\+::object\+\_\+pool}}$<$ T, Allocator, Align, object\+\_\+allocation, Enable\+Unique\+Ptr, Generate\+Stats $>$\+::make\+\_\+shared (\begin{DoxyParamCaption}\item[{Args \&\&...}]{args }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}



Experimental. Returns a shared\+\_\+ptr object built with this \mbox{\hyperlink{classseq_1_1object__pool}{object\+\_\+pool}}. 

\mbox{\Hypertarget{classseq_1_1object__pool_ad3700f4d4fe1eaf5753ffb9383f942cc}\label{classseq_1_1object__pool_ad3700f4d4fe1eaf5753ffb9383f942cc}} 
...
{\footnotesize\ttfamily template$<$class T , class Allocator  = std\+::allocator$<$\+T$>$, size\+\_\+t Align = Default\+Alignment, class object\+\_\+allocation  = linear\+\_\+object\+\_\+allocation$<$1$>$, bool Enable\+Unique\+Ptr = false, bool Generate\+Stats = false$>$ \\
std\+::size\+\_\+t \mbox{\hyperlink{classseq_1_1object__pool}{seq\+::object\+\_\+pool}}$<$ T, Allocator, Align, object\+\_\+allocation, Enable\+Unique\+Ptr, Generate\+Stats $>$\+::memory\+\_\+footprint (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [noexcept]}}



Returns the \mbox{\hyperlink{classseq_1_1object__pool}{object\+\_\+pool}} memory footprint in bytes excluding sizeof($\ast$this). 

\mbox{\Hypertarget{classseq_1_1object__pool_af96e3a376a2c0f05fa1af26444f7891a}\label{classseq_1_1object__pool_af96e3a376a2c0f05fa1af26444f7891a}} 
...
{\footnotesize\ttfamily template$<$class T , class Allocator  = std\+::allocator$<$\+T$>$, size\+\_\+t Align = Default\+Alignment, class object\+\_\+allocation  = linear\+\_\+object\+\_\+allocation$<$1$>$, bool Enable\+Unique\+Ptr = false, bool Generate\+Stats = false$>$ \\
std\+::size\+\_\+t \mbox{\hyperlink{classseq_1_1object__pool}{seq\+::object\+\_\+pool}}$<$ T, Allocator, Align, object\+\_\+allocation, Enable\+Unique\+Ptr, Generate\+Stats $>$\+::peak\+\_\+memory\+\_\+footprint (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [noexcept]}}
...
\mbox{\Hypertarget{classseq_1_1object__pool_af972a9454e9956630a0ed8b9d906ab44}\label{classseq_1_1object__pool_af972a9454e9956630a0ed8b9d906ab44}} 
...
{\footnotesize\ttfamily template$<$class T , class Allocator  = std\+::allocator$<$\+T$>$, size\+\_\+t Align = Default\+Alignment, class object\+\_\+allocation  = linear\+\_\+object\+\_\+allocation$<$1$>$, bool Enable\+Unique\+Ptr = false, bool Generate\+Stats = false$>$ \\
bool \mbox{\hyperlink{classseq_1_1object__pool}{seq\+::object\+\_\+pool}}$<$ T, Allocator, Align, object\+\_\+allocation, Enable\+Unique\+Ptr, Generate\+Stats $>$\+::reclaim\+\_\+memory (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [noexcept]}}
...
Deallocate all unused memory blocks. This only makes sense if \mbox{\hyperlink{classseq_1_1object__pool_af972a9454e9956630a0ed8b9d906ab44}{reclaim\+\_\+memory()}} is false. 
...
\begin{DoxyParams}{Parameters}
{\em alloc\+\_\+size} & only extend the pool in order to allocate alloc\+\_\+size objects per calls to \mbox{\hyperlink{classseq_1_1object__pool_afa83f77752aa9e9d9d60d15380b76d42}{allocate()}} \\
\hline
...
If false, the \mbox{\hyperlink{classseq_1_1object__pool}{object\+\_\+pool}} will not deallocate memory on calls to \mbox{\hyperlink{classseq_1_1object__pool_a99af259462a246f9b6c46a6b00a9a782}{deallocate()}}. Instead, free memory blocks will be added to an internal list and reuse on calls to \mbox{\hyperlink{classseq_1_1object__pool_afa83f77752aa9e9d9d60d15380b76d42}{allocate()}}. This is the only way to move a memory block dedicated to an object count for another object count.
